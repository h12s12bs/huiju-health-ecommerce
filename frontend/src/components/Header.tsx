                  ...
                  <li key={item.id} className={hasDropdown ? 'has-dropdown' : ''}>
                    ...
                    {item.category === 'apparel' && (
                      <ul className="dropdown-menu">
                        <li><a href="#apparel" onClick={(e) => { e.preventDefault(); setCurrentPage('shop'); setCategory('apparel'); setIsAdminMode(false); }}>深海魚油 (rTG 型態)</a></li>
                        ...
                        <li><a href="#apparel" onClick={(e) => { e.preventDefault(); setCurrentPage('shop'); setCategory('apparel'); setIsAdminMode(false); }}>心血管健康保養</a></li>
                      </ul>
                    )}
                    {item.category === 'accessories' && (
                      <ul className="dropdown-menu">
                        ...
                        <li><a href="#accessories" onClick={(e) => { e.preventDefault(); setCurrentPage('shop'); setCategory('accessories'); setIsAdminMode(false); }}>個人日常保健</a></li>
                      </ul>
                    )}
                    {item.category === 'outing' && (
                      <ul className="dropdown-menu">
                        <li><a href="#outing" onClick={(e) => { e.preventDefault(); setCurrentPage('shop'); setCategory('outing'); setIsAdminMode(false); }}>專利百億益生菌</a></li>
